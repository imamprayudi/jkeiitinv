...
{{ header("Content-Disposition: attachment; filename=Data Conversi Part from Finish Good.xls") }}
<table>
    <tr>
        <th colspan="6" style="font-size:18pt;" align="left">LAPORAN KONVERSI PART FINISH GOOD</th>
    </tr>
    <tr><th></th></tr>
</table>
<table border="1">
